...
function LIBRARY() {									# <------ ERROR TEST
	...
	if [ ! -f /usr/lib/libmpc.la ]; then
		...
		libmpcStatus=1											# <------ ERROR TEST, CHANGE TO 'ZERO' WHEN DONE
	else
...
function display() {
	...
	titleHeader
	tput bold
	tput cup 3 $vc1; echo "Package";				tput cup 3 $vc2; echo "Current";	tput cup 3 $vc3; echo "Status"
	tput sgr0
	tput cup 4 $vc1; echo "Bash";						tput cup 4 $vc2; echo $bashVersion;				tput cup 4 $vc3; echo $bashStatus;
	tput cup 5 $vc1; echo "Bash Symbolic";	tput cup 5 $vc2; echo $bashLink;					tput cup 5 $vc3; echo $bashSymStatus;
	tput cup 6 $vc1; echo "BinUtils";				tput cup 6 $vc2; echo $binutilsVersion;		tput cup 6 $vc3; echo $binutilsStatus;
	tput cup 7 $vc1; echo "Bison";					tput cup 7 $vc2; echo $bisonVersion;			tput cup 7 $vc3; echo $bisonStatus;
	tput cup 8 $vc1; echo "Bison Link";			tput cup 8 $vc2; echo $bisonLink;					tput cup 8 $vc3; echo $bisonSymStatus;
	tput cup 9 $vc1; echo "BZip2";					tput cup 9 $vc2; echo $bzip2Version;			tput cup 9 $vc3; echo $bzip2Status;
	tput cup 10 $vc1; echo "CoreUtils";			tput cup 10 $vc2; echo $coreUtilsVersion;	tput cup 10 $vc3; echo $coreUtilsStatus;
	tput cup 11 $vc1; echo "DiffUtils";			tput cup 11 $vc2; echo $diffUtilsVersion;	tput cup 11 $vc3; echo $diffUtilsStatus;
	tput cup 12 $vc1; echo "FindUtils";			tput cup 12 $vc2; echo $findUtilsVersion;	tput cup 12 $vc3; echo $findUtilsStatus;
	tput cup 13 $vc1; echo "Gawk";					tput cup 13 $vc2; echo $gawkVersion;			tput cup 13 $vc3; echo $gawkStatus;
	tput cup 14 $vc1; echo "Gawk Link";			tput cup 14 $vc2; echo $gawkLink;					tput cup 14 $vc3; echo $gawkSymStatus;
	tput cup 15 $vc1; echo "GCC";						tput cup 15 $vc2; echo $gccVersion;				tput cup 15 $vc3; echo $gccStatus;
	tput cup 16 $vc1; echo "GCC G++"; 			tput cup 16 $vc2; echo $gccgplusVersion;	tput cup 16 $vc3; echo $gccGplusStatus;
	tput cup 17 $vc1; echo "GCC Test"; 			tput cup 17 $vc2; echo $gccTest;					tput cup 17 $vc3; echo $gccTestStatus;
	tput cup 18 $vc1; echo "Glibc";					tput cup 18 $vc2; echo $glibcVersion;			tput cup 18 $vc3; echo $glibcStatus;
	tput cup 19 $vc1; echo "Grep";					tput cup 19 $vc2; echo $grepVersion;			tput cup 19 $vc3; echo $grepStatus;
	tput cup 20 $vc1; echo "GZip";					tput cup 20 $vc2; echo $gzipVersion;			tput cup 20 $vc3; echo $gzipStatus;
	tput cup 21 $vc1; echo "Linux Kernel";	tput cup 21 $vc2; echo $kernelVersion;		tput cup 21 $vc3; echo $kernelStatus;
	tput cup 22 $vc1; echo "M4";						tput cup 22 $vc2; echo $m4Version;				tput cup 22 $vc3; echo $m4Status;
	tput cup 23 $vc1; echo "Make";					tput cup 23 $vc2; echo $makeVersion;			tput cup 23 $vc3; echo $makeStatus;
	tput cup 24 $vc1; echo "Patch";					tput cup 24 $vc2; echo $patchVersion;			tput cup 24 $vc3; echo $patchStatus;
	tput cup 25 $vc1; echo "Perl";					tput cup 25 $vc2; echo $perlVersion;			tput cup 25 $vc3; echo $perlStatus;
	tput cup 26 $vc1; echo "Sed";						tput cup 26 $vc2; echo $sedVersion;				tput cup 26 $vc3; echo $sedStatus;
	tput cup 27 $vc1; echo "Tar";						tput cup 27 $vc2; echo $tarVersion;				tput cup 27 $vc3; echo $tarStatus;
	tput cup 28 $vc1; echo "TexInfo";				tput cup 28 $vc2; echo $texinfoVersion;		tput cup 28 $vc3; echo $texinfoStatus;
	tput cup 29 $vc1; echo "Xz";						tput cup 29 $vc2; echo $xzVersion;				tput cup 29 $vc3; echo $xzStatus;
	...
	printf $line
	tput cup 37 $anyKey; pressAnyKey
	tput clear
}
