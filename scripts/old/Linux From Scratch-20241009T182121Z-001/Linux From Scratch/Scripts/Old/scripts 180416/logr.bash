#!/bin/bash
# Logging utility that simplifies user of bash logger
# url: https://gist.githubusercontent.com/ttscoff/6708b082e151ed4910e85f3fde35e9ad/raw/0686fd8713c0710f1097f8c563788cb50d9dbb6a/logr.bash

# # First source the script
# source ~/scripts/logr.bash

# # Start the logger, generates log name from scripts
# logr start
# # or define your own
# logr start LOG_NAME
#
...
logr() {
    ...
    # start must be called first, initializes logging, sets global log filename
