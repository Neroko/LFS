...
function display() {
	...
	printf $line
	tput bold
	tput cup 3 $c1; echo "Package";					tput cup 3 $c2; echo "Current";	tput cup 3 $c3; echo "Status"
	tput sgr0
	tput cup 4 $c1; echo "Bash";						tput cup 4 $c2; echo $bashVersion;				tput cup 4 $c3; echo $bashStatus;
	tput cup 5 $c1; echo "Bash Symbolic";		tput cup 5 $c2; echo $bashLink;						tput cup 5 $c3; echo $bashSymStatus;
	tput cup 6 $c1; echo "BinUtils";				tput cup 6 $c2; echo $binutilsVersion;		tput cup 6 $c3; echo $binutilsStatus;
	tput cup 7 $c1; echo "Bison";						tput cup 7 $c2; echo $bisonVersion;				tput cup 7 $c3; echo $bisonStatus;
	tput cup 8 $c1; echo "Bison Link";			tput cup 8 $c2; echo $bisonLink;					tput cup 8 $c3; echo $bisonSymStatus;
	tput cup 9 $c1; echo "BZip2";						tput cup 9 $c2; echo $bzip2Version;				tput cup 9 $c3; echo $bzip2Status;
	tput cup 10 $c1; echo "CoreUtils";			tput cup 10 $c2; echo $coreUtilsVersion;	tput cup 10 $c3; echo $coreUtilsStatus;
	tput cup 11 $c1; echo "DiffUtils";			tput cup 11 $c2; echo $diffUtilsVersion;	tput cup 11 $c3; echo $diffUtilsStatus;
	tput cup 12 $c1; echo "FindUtils";			tput cup 12 $c2; echo $findUtilsVersion;	tput cup 12 $c3; echo $findUtilsStatus;
	tput cup 13 $c1; echo "Gawk";						tput cup 13 $c2; echo $gawkVersion;				tput cup 13 $c3; echo $gawkStatus;
	tput cup 14 $c1; echo "Gawk Link";			tput cup 14 $c2; echo $gawkLink;					tput cup 14 $c3; echo $gawkSymStatus;
	tput cup 15 $c1; echo "GCC";						tput cup 15 $c2; echo $gccVersion;				tput cup 15 $c3; echo $gccStatus;
	tput cup 16 $c1; echo "GCC G++"; 				tput cup 16 $c2; echo $gccgplusVersion;		tput cup 16 $c3; echo $gccGplusStatus;
	tput cup 17 $c1; echo "GCC Test"; 			tput cup 17 $c2; echo $gccTest;						tput cup 17 $c3; echo $gccTestStatus;
	tput cup 18 $c1; echo "Glibc";					tput cup 18 $c2; echo $glibcVersion;			tput cup 18 $c3; echo $glibcStatus;
	tput cup 19 $c1; echo "Grep";						tput cup 19 $c2; echo $grepVersion;				tput cup 19 $c3; echo $grepStatus;
	tput cup 20 $c1; echo "GZip";						tput cup 20 $c2; echo $gzipVersion;				tput cup 20 $c3; echo $gzipStatus;
	tput cup 21 $c1; echo "Linux Kernel";		tput cup 21 $c2; echo $kernelVersion;			tput cup 21 $c3; echo $kernelStatus;
	tput cup 22 $c1; echo "M4";							tput cup 22 $c2; echo $m4Version;					tput cup 22 $c3; echo $m4Status;
	tput cup 23 $c1; echo "Make";						tput cup 23 $c2; echo $makeVersion;				tput cup 23 $c3; echo $makeStatus;
	tput cup 24 $c1; echo "Patch";					tput cup 24 $c2; echo $patchVersion;			tput cup 24 $c3; echo $patchStatus;
	tput cup 25 $c1; echo "Perl";						tput cup 25 $c2; echo $perlVersion;				tput cup 25 $c3; echo $perlStatus;
	tput cup 26 $c1; echo "Sed";						tput cup 26 $c2; echo $sedVersion;				tput cup 26 $c3; echo $sedStatus;
	tput cup 27 $c1; echo "Tar";						tput cup 27 $c2; echo $tarVersion;				tput cup 27 $c3; echo $tarStatus;
	tput cup 28 $c1; echo "TexInfo";				tput cup 28 $c2; echo $texinfoVersion;		tput cup 28 $c3; echo $texinfoStatus;
	tput cup 29 $c1; echo "Xz";							tput cup 29 $c2; echo $xzVersion;					tput cup 29 $c3; echo $xzStatus;
	...
	LIBRARY
	tput cup 33 $c1; echo "libgmp.la";			tput cup 33 $c2; echo $libgmpFile;	tput cup 33 $c3; echo $libraryStatus;
	tput cup 34 $c1; echo "libmpfr.la";			tput cup 34 $c2; echo $libmpfrFile;
	tput cup 35 $c1; echo "libmpc.la";			tput cup 35 $c2; echo $libmpcFile;
