...
function prep() {
	...
	LOG=$LFS_SOURCES/pass1/logs/pass1.log		# Log location
...
function cleanOld() {					# Delete all old files
	{
		time {
			INFO "Cleaning out old files..."
			`bash startover.sh`
			INFO "Complete"
		}
